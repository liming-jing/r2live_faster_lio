...
void buildVoxelMap(const std::vector<pointWithCov> &input_points,
                   ...
                   std::std::unordered_map<VOXEL_LOC, OctoTree *> &feat_map) {
...
// void BuildResidualListTBB(const std::unordered_map<VOXEL_LOC, OctoTree *>
// &voxel_map,
...
void pubNoPlaneMap(const std::std::unordered_map<VOXEL_LOC, OctoTree *> &feat_map,
...
void pubVoxelMap(const std::std::unordered_map<VOXEL_LOC, OctoTree *> &voxel_map,
...
void pubPlaneMap(const std::std::unordered_map<VOXEL_LOC, OctoTree *> &feat_map,
                 const ros::Publisher &plane_map_pub) {
